...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
  //Tambien se puede usar la funcion anterior para realizar lo pedido
...
function empiezaConNueve(n) {
  ...
  //Escribe tu código aquí
  let num=n.toString() //Devuelve una cadena de caracteres
  if(num.charAt(0)==='9'){ // Devuelve la posicion del caracter que le pasemos como parametro
    return true
  }
  return false
}
